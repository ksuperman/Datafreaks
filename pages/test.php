               ...
               <div class='row'>
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                           <label>Id</label>
                           <p class='form-control-static'>4002</p>
                       </div>
                      </div>
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                   ...
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                           ...
                           <p class='form-control-static'>Sixth Street</p>
                       </div>
                      </div>
                </div>
            </div>
           ...
           <div class='panel-body'>
               <div class='row'>
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                           <label>Id</label>
                           <p class='form-control-static'>4061</p>
                       </div>
                      </div>
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                   ...
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                           <label>Street Name</label>
                           <p class='form-control-static'>Taylor Street</p>
                       </div>
                      </div>
                </div>
            </div>
           ...
           <div class='panel-body'>
               <div class='row'>
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
                           <label>Id</label>
                           <p class='form-control-static'>4080</p>
                       </div>
                      </div>
                   <div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'
                       <div class='form-group'>
